...
// API
// ----------------------------------------------------------------------
export const BIROBID_API = {
  apiruc: process.env.REACT_APP_RUCRAPI
}
...
// API
// export const RUCEMPRESA = window.localStorage.getItem('ruc'); // GUARDA EL RUC DE LA EMPRESA
export const URLRUC = process.env.REACT_APP_RUCRAPI // OBTIENE EL RUC POR PERSONA
export const URLEMRPRESA = process.env.REACT_APP_RUCEMPRESA; // URL DE LA API DE EMPRESA DEL SISTEMA
...
export const NAVBAR = {
  ...
  DASHBOARD_ITEM_HORIZONTAL_HEIGHT: 30,
};
